...
export const images = [
  ...
  { img: Commencement_img, video: comensmentVideo, button: true, header: "Ithaca College Spring Commencement 2024", description: "For this ceremony and livestream, I was largely responsible for establishing all of the signal flow within the control room and the stadium as well as maintaining organization of the equipment and connections to ensure a smooth program."},
