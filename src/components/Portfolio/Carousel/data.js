...
// import video1 from "../Videos/rx_experience.mp4"
// import video2 from "../Videos/DShaffer_Assn2_Knives_Out.mp4"
// import video3 from "../Videos/superMarioBros.mp4"
...
export const images = [
  ...
  { img: image2, video: afterVideo, button: true, header: "After", description: "This was one of my favorite projects I’ve ever worked on. I enjoyed getting to enhance the story of these two ghosts through the use of sound."},
  { img: image3, video: comensmentVideo, button: true, header: "Ithaca College Spring Commencement 2024", description: "Technical Lead and Technical Director - For this ceremony and livestream, I was largely responsible for establishing all of the signal flow within the control room and the stadium to ensure a smooth "},
  { img: image4, video: video2, button: true, header: "RX Experiance", description: "I was given a short scene from a film for a class  where the location sound was quite messy. I utilized Izotope RX to assist in cleaning lots of the audio."}
];
