...
// import image5 from "../../images/earthToEarthPoster2.jpeg"

// import video0 from "../Videos/from_earth_to_earth__the_lost_art_of_dying_in_america_.mp4"
// import video1 from "../Videos/strike_-_short_animation.mp4"
...
export const images = [
  ...
  { img: image1, video: video1, button: true, header: "Strike!", description: "This was a project I completed for a motion graphics and animation course. I was quite proud of it so I submitted it to the Broadcast Education Association’s On Location Creative Competition where I won Best Short Narrative."},
  ...
  { img: image0, video: video0, button: true, header: "Deer Image", description: "Image Discription"},
  { img: image1, video: video0, button: true, header: "Giraffe Image", description: "Image Discription"},
  { img: image2, video: video0, button: true, header: "Lepord Image", description: "Image Discription"},
  { img: image3, video: video0, button: true, header: "Parot Image", description: "Image Discription"},
  { img: image4, video: video0, button: true, header: "Tiger Image", description: "Image Discription"},
  { img: image0, video: video0, button: true, header: "Deer Image", description: "Image Discription"}
];
